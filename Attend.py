...
window = tk.Tk()
window.title('NIE Attendance system')
...
title = tk.Label(window,text="QR-code Based Attendance System",bd=10,relief=tk.GROOVE,font=("times new roman",40),bg="lavender",fg="black")
...
combo_search['values']=("CSE","ISE","ECE","EEE","MECH","CIVIL","IPE")
...
ttk.Label(window, text = "Made by: Sathkeerthi, Shrivathsa and Vamshi", background="lavender", foreground = "black", font = ("Times New Roman", 15)).place(x=100, y=500)
